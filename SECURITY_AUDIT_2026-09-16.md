...
**ยังไม่แก้** — B1, C10, C11 ดูรายละเอียดด้านล่างและลำดับที่แนะนำท้ายเอกสาร
...
### 11. ไม่มี idempotency ที่ไหนเลย — วัดขนาดแล้ว 19 ก.ย. ยังไม่แก้ รอตัดสินใจ
...
**ยังไม่ทำเพราะกระทบ client ที่เรามองไม่เห็น** ข้อมูลบอกว่าปกติ 1 บิล = 1 แถว (1,598 จาก 1,621 เลขบิล) แต่มี 20 เลขที่มีหลายแถว ถ้าฝั่ง KIOSK ตั้งใจยิงหลายครั้งด้วยเลขเดียวกันสำหรับบิลหลายรายการ guard นี้จะไปตัดของที่ใช้งานอยู่ **ต้องยืนยันพฤติกรรมฝั่ง KIOSK ก่อน** ถึงจะเปิด guard ได้
